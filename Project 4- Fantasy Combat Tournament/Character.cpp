...
/*
getName function: returns the name
*/
...
/*
setNmae fucntion: mutator for name 
*/
...
/*
restoreDamage randomly selects number between 1-5 to restore damage of char
*/
int Character::restoreDamage()
{
	std::cout << "Damage will now be restored." << std::endl;
	double reset = rand() % 5 + 1;
	return reset;
}
